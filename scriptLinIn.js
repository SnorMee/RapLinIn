...
var paper = Raphael("canvas", 1200+10 , 1200*3/4+10)
console.log(createData(dataThreatTotal,dataThreatType,'Abarema'))
doneData = createData(dataThreatTotal,dataThreatType,'Acacia');
drawCanvas(doneData)
